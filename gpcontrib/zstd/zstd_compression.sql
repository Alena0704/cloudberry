...
LANGUAGE C VOLATILE AS '$libdir/gp_zstd_compression', 'zstd_constructor';
...
LANGUAGE C VOLATILE AS '$libdir/gp_zstd_compression', 'zstd_destructor';
...
LANGUAGE C VOLATILE AS '$libdir/gp_zstd_compression', 'zstd_compress';
...
LANGUAGE C VOLATILE AS '$libdir/gp_zstd_compression', 'zstd_decompress';
...
LANGUAGE C VOLATILE AS '$libdir/gp_zstd_compression', 'zstd_validator';
